...
export const privacyContent: LocalizedLegalDoc = {
  en: {
    ...
    intro: [
      "ClinicRadar (\"ClinicRadar\", \"we\", \"us\") is a competitor-intelligence service for clinics. It compares the public reviews of your business (Google Maps and, where available, Trustpilot) with those of nearby competitors and turns the gap into a short, actionable task list.",
    ...
    atAGlance: [
      "We collect your account details, the business and competitors you select, and publicly available review data from Google Maps and Trustpilot.",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Publicly available review data — public reviews of the businesses being analyzed (your own and the competitors you select), including review text, star rating, review date and the reviewer's public display name. We collect these from public review platforms: Google Maps (via the Google Places API and the Apify platform) and, where the business has a public profile, Trustpilot (via Apify).",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Legitimate interests — processing publicly available review data to produce competitive analysis, and securing our systems (GDPR Art. 6(1)(f); KVKK Art. 5(2)(f)). We only process review data that reviewers have chosen to make public on the platforms we collect from (Google Maps, Trustpilot), we use it solely for analysis, and we never republish individual reviews.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Apify — collection of publicly available reviews from Google Maps and Trustpilot.",
      ...
      },
      {
        ...
        paragraphs: [
          "ClinicRadar analyzes reviews that reviewers have voluntarily published on public review platforms — Google Maps and Trustpilot — where they are visible to anyone. We collect this data through the Google Places API and Apify, use it only to produce aggregated, paraphrased insights for the business being analyzed, and never display or republish individual reviews or reviewer identities in the product.",
  ...
  tr: {
    ...
    intro: [
      "ClinicRadar (\"ClinicRadar\", \"biz\"), klinikler için bir rakip istihbaratı hizmetidir. İşletmenizin herkese açık yorumlarını (Google Haritalar ve varsa Trustpilot) çevrenizdeki rakiplerinkiyle karşılaştırır ve aradaki farkı kısa, uygulanabilir bir görev listesine çevirir.",
    ...
    atAGlance: [
      "Hesap bilgilerinizi, seçtiğiniz işletme ve rakipleri ve Google Haritalar ile Trustpilot'taki herkese açık yorum verilerini topluyoruz.",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Herkese açık yorum verileri — analiz edilen işletmelerin (kendi işletmeniz ve seçtiğiniz rakipler) herkese açık yorumları: yorum metni, yıldız puanı, yorum tarihi ve yorumu yazan kişinin herkese açık görünen adı. Bu veriler herkese açık yorum platformlarından toplanır: Google Haritalar (Google Places API ve Apify platformu üzerinden) ve işletmenin herkese açık bir profili varsa Trustpilot (Apify üzerinden).",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Meşru menfaat — rekabet analizi üretmek için herkese açık yorum verilerinin işlenmesi ve sistemlerimizin güvenliği (GDPR m. 6/1-f; KVKK m. 5/2-f). Yalnızca yorum sahiplerinin, veri topladığımız platformlarda (Google Haritalar, Trustpilot) alenileştirdiği verileri işleriz, bunları sadece analiz için kullanırız ve tekil yorumları asla yeniden yayımlamayız.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Apify — Google Haritalar ve Trustpilot'taki herkese açık yorumların toplanması.",
      ...
      },
      {
        ...
        paragraphs: [
          "ClinicRadar, yorum sahiplerinin herkese açık yorum platformlarında — Google Haritalar ve Trustpilot — gönüllü olarak yayımladığı ve herkesin görebildiği yorumları analiz eder. Bu verileri Google Places API ve Apify üzerinden toplar, yalnızca analiz edilen işletme için toplulaştırılmış ve yeniden ifade edilmiş içgörüler üretmek amacıyla kullanır; tekil yorumları veya yorum sahiplerinin kimliklerini üründe asla göstermez ya da yeniden yayımlamaz.",
